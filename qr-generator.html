...
<head>
    ...
    <meta name="description" content="ابزار تولید QR Code برای استاد بازی">
    <title>تولید QR Code - اینفرنال</title>
    <link rel="manifest" href="/manifest.json">
    <link rel="icon" type="image/svg+xml" href="/favicon.svg">
    <link rel="stylesheet" href="/src/qr-generator.css">
</head>
<body>
    <div id="app">
        <header>
            ...
            <div class="controls-panel">
                ...
                <div class="form-group">
                    ...
                    <select id="qrStyle">
                        ...
                        <option value="gradient" selected>گرادیانت رنگی</option>
                ...
                <div class="form-group" id="customColorsGroup" style="display: none;">
                    ...
                    <div class="color-input-group">
                        ...
                        <input type="text" id="qrColorText" value="#000000">
                    </div>
                </div>

                <div class="form-group" id="customBgGroup" style="display: none;">
                ...
                <div class="form-group">
                    <label for="margin">حاشیه (Margin): <span id="marginValue">4</span></label>
                    <input 
                        type="range" 
                        id="margin" 
                        min="0" 
                ...
                <div class="form-group">
                    <label for="scale">مقیاس (Scale): <span id="scaleValue">10</span></label>
                    <input 
                        type="range" 
                        id="scale" 
                        min="5" 
                ...
                <div class="form-group">
                    ...
                    <input 
                        ...
                        accept="image/*"
                    >
                    <button id="clearLogo" class="btn-secondary" style="display: none;">حذف لوگو</button>
    ...
    <script type="module" src="/src/qr-generator.js"></script>
</body>
</html>
