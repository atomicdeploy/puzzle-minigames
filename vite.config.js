...
export default defineConfig(({ command, mode }) => {
  ...
  return {
    ...
    server: {
      ...
      https: useHttps, // Enable with: https: true or https: { key: 'path/to/key.pem', cert: 'path/to/cert.pem' }
      ...
      hmr: {
        ...
        protocol: useHttps ? 'wss' : 'ws', // Automatically use 'wss' for HTTPS, 'ws' for HTTP
